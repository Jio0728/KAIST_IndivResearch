...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--exp_dir', default="results/blue_hair", type=str, help='Path to experiment output directory')
		...
		self.parser.add_argument('--latents_train_path', default="latents_pt/train_faces.pt", type=str, help="The latents for the training")
		self.parser.add_argument('--latents_test_path', default="latents_pt/test_faces.pt", type=str, help="The latents for the validation")
		...
		self.parser.add_argument('--checkpoint_path', default=None, type=str, help='Path to StyleCLIPModel model checkpoint') #inference 그 때 안 돼서 이거 넣어놨는데, 이제 필요 없어서 뺌.
		self.parser.add_argument('--styleNeRFckpt', default="pretrained_models/ffhq_256.pkl", type=str, help='Path to styleNeRF Generator checkpoint')
		...
		self.parser.add_argument('--NeRFMapping', required=False, type=bool, help='generate w latent using styleNeRF mapping layer')
		self.parser.add_argument('--train_seed', required=False, type=int, help='seed for generating w latent using styleNeRF mapping layer')
		self.parser.add_argument('--test_seed', required=False, type=int, help='seed for generating w latent using styleNeRF mapping layer')
